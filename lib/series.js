...
const repository = createGachaRepository(getInitialRecords());
...
export function createRepositoryFromDataSource(dataSource = createStaticGachaDataSource(getInitialRecords())) {
