...
import { fetchPublicSitemapRows, fetchSeriesObserverRows } from "./data/public-sitemap-identifiers";
import {
...
function enrichParentSeries(parent, variants, records, indexes) {
  ...
  return {
    ...
    market_evidence: marketSummary.complete_set_evidence ?? marketSummary.evidence,
