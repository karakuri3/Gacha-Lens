...
async function fetchSignalsForCatalog(client, catalog) {
  ...
  const [variantMarket, seriesMarket, marketObservations, xReactions, restockEvents, stockReports] = await Promise.all([
    ...
    fetchRowsIn(client, TABLE_MAP.marketObservations, TABLE_SELECTS.marketObservations, "variant_id", variantIds),
