...
export const INGESTION_TASKS = {
  official: { name: "official", script: "upsert-official-data.mjs" },
  market: { name: "market", script: "upsert-market-data.mjs" },
  x: { name: "x", script: "upsert-x-reactions.mjs" },
  stock: { name: "stock", script: "upsert-stock-data.mjs" },
};
