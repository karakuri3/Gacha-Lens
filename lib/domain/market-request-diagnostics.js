...
} from "../fetchers/market-request-budget.js";
...
const MAX_QUERIES = MARKET_MAX_DIAGNOSTIC_ENTRIES;
const MAX_ATTEMPTS = 3;
const MAX_QUERY_LENGTH = 160;

if (MAX_ATTEMPTS !== MARKET_MAX_RETRY_ATTEMPTS_PER_REQUEST) {
  throw new Error("Market diagnostics retry capacity does not match the request-budget contract.");
}
