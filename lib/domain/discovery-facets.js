...
export function decodeDiscoveryFacetParam(value) {
  // Non-ASCII links are double-percent-encoded so the vinext dynamic-route
  // boundary receives only ASCII. Preserve the bounded route input here and let
  // lookup candidate decoding resolve the public display value.
