...
export const OFFICIAL_BOUNDED_AUTO_POLICY_APPROVAL = "APPROVE_OFFICIAL_BOUNDED_AUTO_V1";
...
export function expectedOfficialAutoApproval() {
  return OFFICIAL_BOUNDED_AUTO_POLICY_APPROVAL;
}
...
export function resolveOfficialAutoGate({
  ...
  const approvalValid = text(approval) === expectedOfficialAutoApproval();
  if (!approvalValid) {
