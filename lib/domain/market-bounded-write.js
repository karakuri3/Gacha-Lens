...
export class MarketBoundedWriteError extends Error {
  constructor(reasonCode, category = "safety_gate", message = reasonCode, diagnostic = null) {
    super(message);
...
function fail(reasonCode, category = "safety_gate", message = reasonCode, diagnostic = null) {
  return new MarketBoundedWriteError(reasonCode, category, cleanText(message, 300), diagnostic);
}
