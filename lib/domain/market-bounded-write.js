...
export const MARKET_BOUNDED_PERSISTENCE_POLICIES = Object.freeze({
  ...
  p1_distinct_v1: Object.freeze({ name: "p1-distinct-bounded-v1", max_candidates: 1, insert_only: true }),
  p2_distinct_v1: Object.freeze({ name: "p2-distinct-bounded-v1", max_candidates: 2, insert_only: true }),
...
function resolvePersistencePolicy(policy) {
  ...
  if (policy === MARKET_BOUNDED_PERSISTENCE_POLICIES.p1_distinct_v1) return MARKET_BOUNDED_PERSISTENCE_POLICIES.p1_distinct_v1;
  if (policy === MARKET_BOUNDED_PERSISTENCE_POLICIES.p2_distinct_v1) return MARKET_BOUNDED_PERSISTENCE_POLICIES.p2_distinct_v1;
