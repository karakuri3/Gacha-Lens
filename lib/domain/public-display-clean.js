...
export function buildReleasedCustomerMetrics(item = {}) {
  return [
    ...
    {
      label: RELEASED_METRIC_LABELS.estimatedResale,
      value: formatPriceRange(item.estimated_resale_range ?? item.market_summary?.estimated_resale_range),
      tone: "highlight",
    },
