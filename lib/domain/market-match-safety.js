...
export function prepareMarketSafetyCatalog(catalog = {}) {
  ...
  return {
    ...catalog,
    formalVariantsBySeries: catalog.formalVariantsBySeries instanceof Map
      ? catalog.formalVariantsBySeries
      : buildFormalVariantsBySeries(catalog.variants ?? []),
    formalSeriesByFranchise: catalog.formalSeriesByFranchise instanceof Map
      ? catalog.formalSeriesByFranchise
      : buildFormalSeriesByFranchise(catalog.series ?? []),
  };
}
