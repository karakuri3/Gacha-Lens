...
export function describeMarketFetcherSafety() {
  return {
    ...
    reason: "Market collection uses approved JSON/CSV feeds or exports first. Uncontrolled scraping is intentionally not part of the primary cron path.",
    acceptedInputs: ["marketListingsRaw JSON", "market CSV export", "manual export converted to JSON", "approved marketplace API response"],
    env: "MARKET_RAW_FEED_URLS or MARKET_RAW_FEED_SOURCES_JSON",
