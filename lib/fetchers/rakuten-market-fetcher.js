...
async function fetchRakutenKeyword(url, { keyword, queryIndex, requestOrigin, retryOptions, fetchImpl, sleep, clock, random }) {
...
function normalizeRakutenItem(item, context) {
  ...
  const sourceUrl = affiliateUrl || publicItemUrl;
  const imageUrls = [
